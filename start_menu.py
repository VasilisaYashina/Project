...
# 1) display - переменная, содержащая само окно, измени её на название своей переменной, содержащей окно
...
def start_menu():
    ...
    while show:
        ...
        display.blit(menu_bckgr, (0, 0))  # display - название переменной, содержащей окно с программой
        start_button.draw(300, 200, 'Начать наше путешествие', start_game, 50)
